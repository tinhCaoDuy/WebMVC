...
<body>
			...
			<div class="col-md-6 header-middle">
				<form action="search/1.htm" method="get" class="form__search" >
					<input width="380px" height="50px" type="search" name="search"
						placeholder="Search here..." required="" style="color: white;"> <input
	...
	<div class="container">
		<div class="row">
			<div class="col col-xs-12" style="color: black;">
						...
						<tbody>
							<c:forEach var="item" items="${list}">
								<tr>
									...
									<td>${item.product.price-((item.product.discount/100)*item.product.price)}</td>
									<td><input
									...
									<td>${(item.product.price-((item.product.discount/100)*item.product.price))*item.amount}</td>
