	...
	<div class="container">
		<div class="row">
			<div class="col col-xs-12">
				<h1 style="margin-top: 30px; color: black;">Lịch Sử Mua Hàng</h1>
			</div>
			<a style="margin-left: 45em" class="btn btn-success" href="cart.htm">Trở Về</a>
		</div>
							...
							<c:forEach var="item" items="${listCart}">
								<tr>
									...
									<td><a class="btn btn-success"
										href="history_cart/${item.id}.htm"><i
